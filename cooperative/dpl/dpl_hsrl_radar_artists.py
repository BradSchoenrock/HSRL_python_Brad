...
class dpl_allradar_hsrl_images_artist(dplkit.role.artist.aArtist):
    ...
    def renderframe(self,frame):
            ...
            if self.subframename==None:
                ...
                if usetimes==None or usealts==None:
                    print "Can't find native raw radarshsrl axes in artist."
                ...
                if usetimes==None and hasattr(nativeframe,'times'):
                    usetimes=nativeframe.times
                if usetimes==None or usealts==None:
                    print "Can't find native raw radarshsrl",self.subframename,"range axes in artist."
            ...
            try:
                ...
                print 'failed to render merge radars/hsrl'
                traceback.print_exc()
                pass
    ...
    def rendernativeframe(self,rs,usetimes,usealts,wholeframe=None):
            ...
            self.rhd.show_hsrl_radar(display_defaults,rs,None,usetimes,usealts,figs,**additionalparameters)
