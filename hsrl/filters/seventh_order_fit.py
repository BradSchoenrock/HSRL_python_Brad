...
def seventh_order_fit(bin0,bin1,bin2,bin3,v0,v1,v2,v3,s0,s1,s2,s3):
    ...
    in_array = np.array([[bin0**7,bin0**6,bin0**5,bin0**4,bin0**3,bin0**2,bin0,1.0]
                        ,[bin1**7,bin1**6,bin1**5,bin1**4,bin1**3,bin1**2,bin1,1.0]
                        ,[bin2**7,bin2**6,bin2**5,bin2**4,bin2**3,bin2**2,bin2,1.0]
                        ,[bin3**7,bin3**6,bin3**5,bin3**4,bin3**3,bin3**2,bin3,1.0] 
                        ,[7.0*bin0**6,6.0*bin0**5,5.0*bin0**4,4.0*bin0**3,3.0*bin0**2,2.0*bin0,1.0,0.0]
                        ,[7.0*bin1**6,6.0*bin1**5,5.0*bin1**4,4.0*bin1**3,3.0*bin1**2,2.0*bin1,1.0,0.0] 
                        ,[7.0*bin2**6,6.0*bin2**5,5.0*bin2**4,4.0*bin2**3,3.0*bin2**2,2.0*bin2,1.0,0.0]
                        ,[7.0*bin3**6,6.0*bin3**5,5.0*bin3**4,4.0*bin3**3,3.0*bin3**2,2.0*bin3,1.0,0.0]])
    
    in_vector = np.array([v0,v1,v2,v3,s0,s1,s2,s3])
